...
public class StageAjoutSae implements Initializable {
    private Stage stage;
    ...
    public static Stage creer(Module module, StageSaisieSae parent) throws IOException
    {
        ...
        StageAjoutSae stageCtrl = fxmlLoader.getController();
