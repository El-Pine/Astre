...
public class StageSaisieRessource implements Initializable
{
	...
	public void initialize(URL location, ResourceBundle resources)
	{
		...
		ObservableList<SaisieRessource> elements = FXCollections.observableArrayList(
				...
				new SaisieRessource("aaaaaa", "bbbbbb", 156, 10.2, "ccccc"),
				new SaisieRessource("aaaaaa", "bbbbbb", 156, 10.2, "ccccc"),
				new SaisieRessource("aaaaaa", "bbbbbb", 15, 10.2, "ccccc"),
				new SaisieRessource("aaaaaa", "bbbbbb", 16, 10.2, "ccccc"),
				new SaisieRessource("aaaaaa", "bbbbbb", 17, 10.2, "ccccc"),
				new SaisieRessource("aaaaaa", "bbbbbb", 18, 10.2, "ccccc"),
				new SaisieRessource("aaaaaa", "bbbbbb", 156, 10.2, "ccccc"),
				new SaisieRessource("aaaaaa", "bbbbbb", 156, 10.2, "ccccc"),
				new SaisieRessource("aaaaaa", "bbbbbb", 156, 10.2, "ccccc"),
				new SaisieRessource("aaaaaa", "bbbbbb", 156, 10.2, "ccccc"),
