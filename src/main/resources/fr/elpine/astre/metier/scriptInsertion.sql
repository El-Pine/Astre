...
INSERT INTO Semestre (numero, annee, nbGrpTD, nbGrpTP, nbEtd, nbSemaine) VALUES
    ...
    (1, '2023-2024', 5, 5, 100, 15),
    (2, '2023-2024', 5, 5, 100, 15),
    (3, '2023-2024', 5, 5, 100, 15),
    (4, '2023-2024', 5, 5, 100, 15),
    (5, '2023-2024', 5, 5, 100, 15),
...
INSERT INTO CategorieIntervenant (code, nom, nbHeureMaxDefaut, nbHeureServiceDefaut, ratioTPDefaut) VALUES
    ('CAT1', 'Enseignant', 20, 15, 0.5),
    ('CAT2', 'Chercheur', 30, 25, 0.6);
...
INSERT INTO Intervenant (nom, prenom, mail, codeCategorie, heureService, heureMax, ratioTP) VALUES
    ('Dupont', 'Jean', 'jean.dupont@example.com', 'CAT1', 18, 20, 0.4),
    ('Martin', 'Alice', 'alice.martin@example.com', 'CAT2', 25, 30, 0.6);
...
INSERT INTO Affectation (codeModule, numeroSemestreModule, anneeModule, idInter, typeHeure, nbGroupe, nbSemaine, nbHeure, commentaire) VALUES
    ('MATH101', 1, '2022-2023', 1, 'CM', 1, 12, 30, 'Affectation pour le semestre 1'),
    ('MATH102', 1, '2022-2023', 1, 'TD', 1, 12, 15, 'Affectation pour le semestre 1'),
    ('PHYS101', 1, '2022-2023', 2, 'TP', 1, 12, 20, 'Affectation pour le semestre 1');
